 ...
 * @author PRIVATE-PC
 */
public class UserDPO extends javax.swing.JFrame implements UserDivisiInterface {

    /**
     * Creates new form UserDPO
     */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("DIVISI PENGEMBANGAN ORGANISASI");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserDPO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void tampilkanProker() {
        ...
        try {
            Connection cn = Koneksi.getKoneksi();
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT namaProker, deskripsiProker, tanggalProker FROM proker WHERE idDivisi=1");
            while (rs3.next()) {
    ...
    public void initAnggota() {
        ...
        try {
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM admin WHERE IdDivisi=1");
            rs.next();
            ...
            Logger.getLogger(UserDPO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
