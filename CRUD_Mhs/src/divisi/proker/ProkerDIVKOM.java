...
public class ProkerDIVKOM extends javax.swing.JFrame implements ProkerInterface {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(idProker, javax.swing.GroupLayout.PREFERRED_SIZE, 795, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void tampilkan() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT idProker, namaProker, deskripsiProker, tanggalProker, fotoProker FROM proker WHERE idDivisi=3");
            while (rs3.next()) {
    ...
    public void tambah() {
        ...
        try {
            Connection cn = Koneksi.getKoneksi();
            cn.createStatement().executeUpdate("INSERT INTO proker VALUES" + "('" + idProker.getText() + "','" + "3' ,'" + namaProker.getText() + "','" + deskripsiProker.getText() + "','" + tanggalProker.getText() + "')");
            tampilkan();
            reset();
        } catch (SQLException ex) {
            Logger.getLogger(MahasiswaAdmin.class.getName()).log(Level.SEVERE, null, ex);
