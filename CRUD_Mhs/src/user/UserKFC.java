 ...
 * @author Kelompok 8
 */
public class UserKFC extends javax.swing.JFrame implements UserOrganisasiInterface {

    /**
     * Creates new form UserKFC
     */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("KEMAKOM FUTSAL CLUB");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserKFC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT NIM, nama, kelas, angkatan, foto FROM mahasiswa WHERE idOrganisasi=3 AND ketuaOrganisasi=0");
            while (rs3.next()) {
            ...
            Logger.getLogger(UserKFC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void initAnggota() {
        ...
        try {
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM mahasiswa WHERE idOrganisasi=3 AND ketuaOrganisasi=1");
            rs.next();
