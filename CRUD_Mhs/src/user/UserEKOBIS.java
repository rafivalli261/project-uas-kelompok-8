 ...
 * @author Kelompok 8
 */
public class UserEKOBIS extends javax.swing.JFrame implements UserDivisiInterface {

    /**
     * Creates new form UserEKOBIS
     */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("DIVISI EKONOMI DAN BISNIS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserEKOBIS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserEKOBIS().setVisible(true);
            }
        });
    }
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            Logger.getLogger(UserEKOBIS.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void tampilkanProker() {
        ...
        try {
            Connection cn = Koneksi.getKoneksi();
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT namaProker, deskripsiProker, tanggalProker FROM proker WHERE idDivisi=7");
            while (rs3.next()) {
