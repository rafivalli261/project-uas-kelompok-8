...
public class UserKEC extends javax.swing.JFrame implements UserOrganisasiInterface {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("KEMAKOM ENGLISH CLUB");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserKEC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT NIM, nama, kelas, angkatan, foto FROM mahasiswa WHERE idOrganisasi=4 AND ketuaOrganisasi=0");
            while (rs3.next()) {
            ...
            Logger.getLogger(UserKEC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void initAnggota() {
        ...
        try {
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM mahasiswa WHERE idOrganisasi=4 AND ketuaOrganisasi=1");
            rs.next();
