 ...
 * @author Kelompok 8
 */
public class UserCLUBINK extends javax.swing.JFrame implements UserOrganisasiInterface {

    /**
     * Creates new form UserCLUBINK
     */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("CLUBINK KEMAKOM");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserCLUBINK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserCLUBINK().setVisible(true);
            }
        });
    }
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT NIM, nama, kelas, angkatan, foto FROM mahasiswa WHERE idOrganisasi=1 AND ketuaOrganisasi=0");
            while (rs3.next()) {
            ...
            Logger.getLogger(UserCLUBINK.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void initAnggota() {
        ...
        try {
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM mahasiswa WHERE idOrganisasi=1 AND ketuaOrganisasi=1");
            rs.next();
