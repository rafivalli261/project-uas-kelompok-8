 ...
 * @author PRIVATE-PC
 */
public class UserDIVROH extends javax.swing.JFrame implements UserDivisiInterface {

    /**
     * Creates new form UserDIVROH
     */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("DIVISI KEROHANIAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserDIVROH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserDIVROH().setVisible(true);
            }
        });
    }
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT NIM, nama, kelas, angkatan, foto FROM mahasiswa WHERE IdDivisi=5 AND KetuaDivisi=0");
            while (rs3.next()) {
    ...
    public void tampilkanProker() {
        ...
        try {
            Connection cn = Koneksi.getKoneksi();
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT namaProker, deskripsiProker, tanggalProker FROM proker WHERE idDivisi=5");
            while (rs3.next()) {
    ...
    public void initAnggota() {
        ...
        try {
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM admin WHERE IdDivisi=5");
            rs.next();
