 ...
 * @author Kelompok 8
 */
public class UserDIVKOM extends javax.swing.JFrame implements UserDivisiInterface {

    /**
     * Creates new form UserDIVKOM
     */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("DIVISI KOMUNIKASI TEKNOLOGI DAN INFORMASI");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(330, 330, 330)
                .addComponent(Nama_Ketua, javax.swing.GroupLayout.PREFERRED_SIZE, 403, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserDIVKOM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserDIVKOM().setVisible(true);
            }
        });
    }
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            Logger.getLogger(UserDIVDIKLAT.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void tampilkanProker() {
        ...
        try {
            Connection cn = Koneksi.getKoneksi();
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT namaProker, deskripsiProker, tanggalProker FROM proker WHERE idDivisi=3");
            while (rs3.next()) {
    ...
    public void initAnggota() {
        ...
        try {
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM admin WHERE IdDivisi=3");
            rs.next();
