 ...
 * @author PRIVATE-PC
 */
public class UserDIVDIKLAT extends javax.swing.JFrame implements UserDivisiInterface {

    /**
     * Creates new form UserDIVDIKLAT
     */
    DefaultTableModel model;

    public UserDIVDIKLAT() {
        initComponents();
        initAnggota();
        initProker();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("DIVISI PENDIDIKAN DAN PELATIHAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserDIVDIKLAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserDIVDIKLAT().setVisible(true);
            }
        });
    }
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT NIM, nama, kelas, angkatan, foto FROM mahasiswa WHERE IdDivisi=4 AND KetuaDivisi=0");
            while (rs3.next()) {
    ...
    public void tampilkanProker() {
        ...
        try {
            Connection cn = Koneksi.getKoneksi();
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT namaProker, deskripsiProker, tanggalProker FROM proker WHERE idDivisi=4");
            while (rs3.next()) {
