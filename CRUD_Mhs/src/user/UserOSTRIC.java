 ...
 * @author PRIVATE-PC
 */
public class UserOSTRIC extends javax.swing.JFrame implements UserOrganisasiInterface {

    /**
     * Creates new form UserOSTRIC
     */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("OPEN SOURCE RESEARCH COMMUNITY");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserOSTRIC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserOSTRIC().setVisible(true);
            }
        });
    }
    ...
    public void tampilkanAnggota() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT NIM, nama, kelas, angkatan, foto FROM mahasiswa WHERE idOrganisasi=2 AND ketuaOrganisasi=0");
            while (rs3.next()) {
            ...
            TabelAnggota.getColumnModel().getColumn(1).setPreferredWidth(70);
            TabelAnggota.getColumnModel().getColumn(2).setPreferredWidth(30);
            TabelAnggota.getColumnModel().getColumn(3).setPreferredWidth(30);
        } catch (SQLException ex) {
            Logger.getLogger(UserOSTRIC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void initAnggota() {
        ...
        try {
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM mahasiswa WHERE idOrganisasi=2 AND ketuaOrganisasi=1");
            rs.next();
            String ketua = rs.getString("nama");
            Nama_Ketua.setText("Ketua : " + ketua);

            ImageIcon icon = new ImageIcon("src/upload/" + rs.getString("foto"));
