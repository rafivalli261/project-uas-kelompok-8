...
public class ProkerEKOBIS extends javax.swing.JFrame implements ProkerInterface {
    ...
    public void tampilkan() {
        ...
        try {
            ...
            ResultSet rs3 = cn.createStatement().executeQuery("SELECT idProker, namaProker, deskripsiProker, tanggalProker FROM proker WHERE idDivisi=7");
            while (rs3.next()) {
    ...
    public void tambah() {
        ...
        try {
            Connection cn = Koneksi.getKoneksi();
            cn.createStatement().executeUpdate("INSERT INTO proker VALUES" + "('" + idProker.getText() + "','" + "7' ,'" + namaProker.getText() + "','" + deskripsiProker.getText() + "','" + tanggalProker.getText() + "')");
            tampilkan();
            reset();
        } catch (SQLException ex) {
            Logger.getLogger(MahasiswaAdmin.class.getName()).log(Level.SEVERE, null, ex);
